...
export default async function Admin() {
  ...
  return <main className="adminShell">
    <section className="adminHero"><div><div className="ey">JURISQUEST CONTROL • COMMERCIAL BUILD</div><h1>Painel de Operações</h1><p>Conteúdo, editais, usuários, direção visual, acesso, conversão e telemetria em uma única camada administrativa.</p></div><div className="adminHeroActions">{first&&<a className="btn primary" href={`/game/${first.mission_id}`}>Testar runtime</a>}<a className="btn" href="/dashboard">Área do aluno</a><a className="btn" href="/reset-password">Minha senha</a></div></section>
    ...
    <section className="adminModules">
      ...
      <div className="adminModule"><span className="moduleIcon">↻</span><div><small>RETENÇÃO</small><h2>Revisões</h2><p>{pendingReviews??0} revisões pendentes. A agenda nasce automaticamente ao concluir a missão e volta como active recall.</p><a href="/review">Abrir central →</a></div></div>
